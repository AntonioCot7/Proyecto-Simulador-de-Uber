[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-24ddc0f5d75046c5622901739e7c5dd533143b0c8e959d652212380cedb1ea36.svg)](https://classroom.github.com/a/wIHWgKrJ)
...
> Esta tarea es parte del test `RegisterDelete.cy.js`. Pasa todos los test para conseguir el puntaje total
...
> Esta tarea es parte del test `PassengerFlow.cy.js`. Pasa todos los test para conseguir el puntaje total
...
> Esta tarea es parte del test `DriverFlow.cy.js`. Pasa todos los test para conseguir el puntaje total
...
> Esta tarea es parte del test `NotFound.cy.js`. Pasa todos los test para conseguir el puntaje total
